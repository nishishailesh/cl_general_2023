...
server = function(input, output, session) 
{
    ...
    statistics_function=function()
    {
        ...
        x=read.csv('/var/gmcs_config/clg.R.conf',
                 header = FALSE,
                 sep = ",",
                 quote = "'")
  ...
  #mm=dbConnect(dbDriver("MySQL"),mysql_conf_data[1][1],mysql_conf_data[2][1],mysql_conf_data[3][1],"127.0.0.1")
  #mm=dbConnect(dbDriver("MySQL"),mysql_conf_data[1][1],mysql_conf_data[2][1],mysql_conf_data[3][1])
  mm=dbConnect(dbDriver("MySQL"),x$V1[1],x$V2[1],x$V3[1])
