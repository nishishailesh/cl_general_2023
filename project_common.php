          ...
          <button class="btn btn-outline-primary dropdown-toggle m-0 p-0" type="button" data-toggle="dropdown">Misc</button>
            <div class="dropdown-menu m-0 p-0">
              <div class="btn-group-vertical  d-block">
                ...
                <button class="btn btn-outline-primary m-0 p-0" formtarget=_blank formaction=survey.php type=submit name=action value=feedback>Feedback</button>
...
{ 
  ...
  echo '<img style="background-color: white;" src="data:image/png;base64,'.$encoded_image.'" width="'.$width.'" height="'.$height.'" />';
}

function make_png($ex_result,$label='',$width=100,$height=100)
{ 
  $encoded_image=base64_encode($ex_result); 
  return '<img style="background-color: white;" src="data:image/png;base64,'.$encoded_image.'" width="'.$width.'" height="'.$height.'" />';
}
...
{ 
  ...
  $img = '<img style="background-color: white;" src="@'.$encoded_image.'" width="'.$width.'" height="'.$height.'" /> ';
  echo $img;
}
...
function get_label_details($link,$label_id)
{
  ...
  */ 
function xxx_prepare_sample_barcode_1D_2D($link,$sample_id,$label_id,$pdf)
{
    $border=0;
