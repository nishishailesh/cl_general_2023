...
--
-- Table structure for table `config_with_png_data`
--

DROP TABLE IF EXISTS `config_with_png_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `config_with_png_data` (
  `name` varchar(100) NOT NULL,
...
--
-- Table structure for table `copy_examination`
--

DROP TABLE IF EXISTS `copy_examination`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `copy_examination` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10014 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qc_equipment` (
  `qc_equipment` varchar(200) NOT NULL,
  PRIMARY KEY (`qc_equipment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10303 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
