...
<form method=post class="form-group m-0 p-0">
	...
	<button class="btn btn-outline-primary m-0 p-0" formaction=get_advanced_id.php type=submit name=action value=advanced_id>Advanced ID (Triplicate)</button>
	<button class="btn btn-outline-primary m-0 p-0" formaction=get_advanced_id_1.php type=submit name=action value=advanced_id>Advanced ID (Single)</button>
