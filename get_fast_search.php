...
function get_dbid($link,$examination_id,$range)
{
  ...
  echo '<button type=submit formaction=xxx_print_sequence.php formtarget=_blank class="btn btn-primary form-control m-1" name=action value=print_dbid>Print</button>';
